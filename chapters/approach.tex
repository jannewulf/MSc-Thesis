...
You can observe the consequences in \Cref{fig:approach:max-vs-avg}, where the green path represents the maximum metric and the blue path represents the average metric.
